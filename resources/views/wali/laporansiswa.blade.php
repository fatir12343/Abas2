        ...
        <main class="h-full overflow-y-auto">
          <div class="container px-6 mx-auto grid">
            ...
            <div class="container mx-auto px-4 py-8">
                ...
                <!-- Date Range Picker -->
                <div class="mb-8">
                    <form action="{{ route('wali.laporansiswa') }}" method="GET" class="flex items-center space-x-4">
                        <div class="relative">
                            ...
                            <div class="bg-gray-50 rounded-lg p-4 shadow student-card">
                                ...
                                <div class="space-y-2">
                                    @foreach ($student['attendancePercentages'] as $status => $percentage)
                                        <div class="flex items-center">
                                            <span class="w-20 text-sm font-medium text-gray-600">{{ $status }}</span>
                                            <div class="w-full bg-gray-200 rounded-full h-2.5 mr-2">
                                                <div class="bg-blue-600 h-2.5 rounded-full" style="width: {{ $percentage }}%"></div>
                                            </div>
                                            <span class="text-sm font-medium text-gray-500">{{ number_format($percentage, 1) }}%</span>
                                        </div>
                                    @endforeach
                                </div>
                                <a href="{{ route('wali.detailsiswa', ['id' => $student['nis']]) }}" class="mt-4 inline-block bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition duration-300">Detail</a>
                            </div>
                        @endforeach
                    </div>
                </div>
