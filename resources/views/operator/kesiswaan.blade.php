                                ...
                                @foreach($kesiswaan as $k)
                                    <tr class="text-gray-700 dark:text-gray-400">
                                        ...
                                        <td class="px-4 py-3 text-sm">
                                            <button class="bg-blue-600 text-white px-4 py-2 rounded" onclick="toggleModalEdit('{{ $k->id }}')">Edit</button>
                                            <button class="bg-red-500 text-white px-4 py-2 rounded" onclick="toggleModal('{{ $k->id }}')">Delete</button>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
