                                ...
                                @foreach($jurusan as $j)
                                    <tr class="text-gray-700 dark:text-gray-400">
                                        ...
                                        <td class="px-4 py-3 text-sm">
                                            <button class="bg-blue-600 text-white px-4 py-2 rounded" onclick="toggleModalEdit('{{ $j->id_jurusan }}')">Edit</button>
                                            <button class="bg-red-500 text-white px-4 py-2 rounded" onclick="toggleModal('{{ $j->id_jurusan }}')">Delete</button>
                                        </td>
                                    </tr>
